...
The standalone server does **not** build or serve CLI binaries. Use the embedded SDK's `buildCli()` to generate them and host them yourself (e.g. GitHub Releases, S3, a CDN). See the [Agent CLI](/guides/agent-cli) guide for details.
