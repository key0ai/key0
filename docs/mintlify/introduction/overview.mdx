...
<Steps>
  ...
  <Step title="Agent receives a token and calls your API">
    Key0 returns a signed JWT (`AccessGrant`). The agent uses it as a Bearer token to call your protected endpoints.
  </Step>
</Steps>
