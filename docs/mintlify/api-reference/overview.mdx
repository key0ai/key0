...
| `GET` | `/install.sh` | None | Generated shell installer for the seller CLI. Standalone only. |
| `GET` | `/cli/:target` | None | Generated seller CLI binary download. Standalone only. |
